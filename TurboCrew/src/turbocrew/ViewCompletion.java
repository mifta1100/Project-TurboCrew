...
public class ViewCompletion extends HBox{
    TableView table;
    ...
    public ViewCompletion() {
        ...
        Label viewCompletionLabel = new Label("View Completion");
        ...
        table.getColumns().addAll(completionIdColumn,
                ...
                overtimeCostColumn,
                finalCostColumn);
        FilteredList<Completion> list = new FilteredList<>(new DAO().getCompletion(), b -> true);
