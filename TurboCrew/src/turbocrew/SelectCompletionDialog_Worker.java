...
public class SelectCompletionDialog_Worker extends HBox{
    TableView table;

    public SelectCompletionDialog_Worker(AddWorkerPayment addWorkerPayment) {
        ...
        table.getColumns().addAll(completionIdColumn,
                ...
                overtimeCostColumn,
                finalCostColumn);
        FilteredList<Completion> list = new FilteredList<>(new DAO().getCompletionAltWorker(), b -> true);
        ...
        selectButton.setOnAction((ActionEvent e) -> {
            try{
                ...
                addWorkerPayment.setCompletion(completion);
                addWorkerPayment.setCompletionFields();
                if(completion == null)
                    throw new Exception();
            }catch(Exception ex){
            ...
            Stage stage = (Stage) SelectCompletionDialog_Worker.this.getScene().getWindow();
            stage.close();
        });
