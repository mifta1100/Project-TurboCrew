...
public class AddWorkerPayment extends HBox {
    ...
    public AddWorkerPayment() {

        GridPane grid = new GridPane();

        Label addWorkerPaymentLabel = new Label("Add Worker Payement");
        addWorkerPaymentLabel.setFont(Font.font("Arial", 24));
        ...
        selectCompletionButton.setOnAction(e -> {
            ...
            dialog.getDialogPane().setContent(new SelectCompletionDialog_Worker(this).getSelectCompletionDialog());
        ...
        Button addWorkerPaymentButton = new Button("Add Worker Payment");
        addWorkerPaymentButton.setOnAction(e -> {
            if(completion == null){
            ...
            if(new DAO().addWorkerPayment(completion.getCompletionId(), paymentDate)){
        ...
        grid.add(addWorkerPaymentLabel, 0, 0, 4, 1);
        ...
        grid.add(addWorkerPaymentButton, 0, 4, 4, 1);

        GridPane.setHalignment(addWorkerPaymentLabel, HPos.CENTER);
        GridPane.setHalignment(selectCompletionButton, HPos.CENTER);
        GridPane.setHalignment(addWorkerPaymentButton, HPos.CENTER);
